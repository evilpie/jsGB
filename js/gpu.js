GPU = {
    ...
    rb: function (addr) {
        ...
        switch (gaddr) {
        case 0:
            return (GPU._lcdon ? 0x80 : 0) | ((GPU._bgtilebase == 0x0000) ? 0x10 : 0) | ((GPU._bgmapbase == 0x1C00) ? 0x08 : 0) | (GPU._bgon ? 1 : 0);
        ...
        case 7:
            for (var i = 0; i < 4; i++) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    GPU._palette.bg[i] = [192, 192, 192, 255];
                    break;
                case 2:
                    GPU._palette.bg[i] = [96, 96, 96, 255];
                    break;
                case 3:
                    GPU._palette.bg[i] = [0, 0, 0, 255];
                    break;
                }
            }
            break;
        ...
        case 8:
            for (var i = 0; i < 4; i++) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    GPU._palette.obj0[i] = [192, 192, 192, 255];
                    break;
                case 2:
                    GPU._palette.obj0[i] = [96, 96, 96, 255];
                    break;
                case 3:
                    GPU._palette.obj0[i] = [0, 0, 0, 255];
                    break;
                }
            }
            break;
        ...
        case 9:
            for (var i = 0; i < 4; i++) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    GPU._palette.obj1[i] = [192, 192, 192, 255];
                    break;
                case 2:
                    GPU._palette.obj1[i] = [96, 96, 96, 255];
                    break;
                case 3:
                    GPU._palette.obj1[i] = [0, 0, 0, 255];
                    break;
                }
            }
            break;
